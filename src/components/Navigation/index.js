...
import AdminPanelSettingsIcon from '@material-ui/icons/Settings';
...
function Navigation() {
  ...
  const { avt, isAuth, username } = useSelector((state) => state.userInfo);
  const isAdmin = isAuth && username === 'lethuphuong2962003a5ca0';
